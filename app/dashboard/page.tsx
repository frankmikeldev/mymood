...
>
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          {/* Logo */}
          <div
            className="p-6 flex items-center gap-3 shrink-0 border-b"
          ...
          >
            ...
            <div>
              <h1 style={{ fontWeight: 800, fontSize: "17px", color: "#111111", fontFamily: font }}>
                MyMood
              </h1>
              <p style={{ fontSize: "11px", color: "#6b7280", fontFamily: font }}>
                Mental Wellness
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p style={{ fontWeight: 600, fontSize: "14px", color: "#111111", fontFamily: font }}>
                  {userName}
                </p>
                <p style={{ fontSize: "11px", color: "#6b7280", fontFamily: font }}>
                  Free Member
...
<header className="flex justify-between items-center mb-8">
  ...
  {/* Bell removed on inner page header */}
</header>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div
              ...
              style={{ backgroundColor: "#FFFFFF", border: "1px solid #E2DDD6", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}
            >
              <p
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          ...
          >
            <h3
              ...
              style={{ fontWeight: 700, color: "#111111", fontFamily: font }}
            >
              Weekly Progress
            </h3>
            <p
